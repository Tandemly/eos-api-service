...
/**
 * @apiDefine TransactionPostModel A valid transaction object to post on the blockchain
 * @apiSuccess {Number} ref_block_num   transaction reference block number
 * @apiSuccess {String} ref_block_prefix  transaction reference block prefix
 * @apiSuccess {String[]} scope         list of EOS accounts in scope for this transaction
 * @apiSuccess {String[]} read_scope    list of EOS accounts in read-only scope for this transaction
 * @apiSuccess {Date} expiration        the expiration date/time of this transaction
 * @apiSuccess {String[]} signatures    list of 64-byte hex signatures
 * @apiSuccess {Object[]} messages      array of messages in this transaction
 * @apiSuccess {Object[]} messages.authorization list of authorizations on this message
 * @apiSuccess {String} messages.authorization.account  the authorized EOS account name
 * @apiSuccess {String} messages.authorization.permission the permission this account is authorized to perform
 * @apiSuccess {String} messages.code the specific message ABI code identifier
 * @apiSuccess {String} messages.type the type of message, ie (`transfer`,`createAccount`)
 * @apiSuccess {Object} messages.data an object containing the data for this message, sepcific to the type of message
 *
 */
